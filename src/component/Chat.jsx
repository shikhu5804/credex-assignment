      ...
      {!isOpen ? (
        ...
        <AnimatePresence>
          <motion.div
            ...
            className="w-80 bg-white dark:bg-zinc-900 border dark:border-zinc-700 rounded-xl shadow-xl p-4 flex flex-col justify-between h-96"
          >
            ...
            <div className="flex-1 overflow-y-auto space-y-2 px-1 text-sm scroll-smooth">
              {messages.length === 0 && (
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="text-center text-gray-500 dark:text-gray-400 text-xs py-4"
                >
